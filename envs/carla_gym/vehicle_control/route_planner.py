...
from envs.carla_gym.misc import distance_vehicle, is_within_distance_ahead, compute_magnitude_angle
...
class RoutePlanner:
    def __init__(self, vehicle, buffer_size, random_road_option=True):
        ...
        # Nearest waypoint in the center of a Driving lane.
        ...
        self._compute_next_waypoints(k=200, random_road_option=random_road_option)

    def _compute_next_waypoints(self, k=1, random_road_option=True):
        """
    ...
    def run_step(self):
        ...
        red_light, vehicle_front = None, None  # self._get_hazard()
        # red_light = False
